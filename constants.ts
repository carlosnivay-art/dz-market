...
export const MOCK_PRODUCTS: any[] = [
  {
    ...
    isFastDelivery: true,
    description: 'سماعات عالية الجودة مع عزل ضجيج نشط.'
  },
  {
    id: '2',
    ...
    isFastDelivery: true,
    description: 'حذاء مريح جدا للمشي والجري لمسافات طويلة.'
  },
  {
    id: '3',
    ...
    description: 'صناعة يدوية جزائرية 100%.'
  },
  {
    id: '4',
    ...
    hasStudentDiscount: true,
    isFastDelivery: true,
    description: 'طقم متكامل لطلبة الفنون والهندسة المعمارية.'
  },
  {
    id: '5',
    name: 'ساعة ذكية S8',
    ...
    hasStudentDiscount: false,
    isFastDelivery: true,
    description: 'ساعة ذكية مقاومة للماء مع تتبع نبضات القلب.'
  }
];
